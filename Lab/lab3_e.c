...
module lab3_e(input CL2947MP_x, input CL2947MP_y, input CL2947MP_z, input CL2947MP_w, output CL2947MP_out);
  ...
  and and(CL2947MP_1, CL2947MP_w, CL2947MP_x);
  and and(CL2947MP_2, CL2947MP_w, CL2947MP_y);
  and and(CL2947MP_3, CL2947MP_xnot, CL2947MP_znot);
  and and(CL2947MP_4, CL2947MP_y, CL2947MP_znot);
